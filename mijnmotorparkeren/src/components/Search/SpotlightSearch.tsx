        ...
        <Dialog.Content className="fixed top-[10%] left-1/2 -translate-x-1/2 w-full max-w-2xl bg-white rounded-xl shadow-2xl z-10000 max-h-[80vh] overflow-hidden">
          ...
          <div className="overflow-y-auto max-h-[60vh]">
            ...
            {!error && results.length > 0 && (
              <ul className="py-2" id="search-results" aria-label="Search results">
                {results.map((gemeente, index) => (
                  <li key={gemeente.id} aria-selected={index === selectedIndex}>
                    <button
                      className={clsx(
                    ...
                    >
                      <div className="flex-1">
                        <div className="font-medium text-gray-900">{gemeente.name}</div>
                        <div className="text-sm text-gray-500">{gemeente.province}</div>
                      </div>
          ...
          <div className="hidden sm:block border-t border-gray-200 px-4 py-3 bg-gray-50">
